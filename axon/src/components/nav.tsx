...
export default function Nav() {
    ...
    return <>
        <div className="w-full  bg-black-100 flex justify-evenly fixed bottom-0  border-t  border-white/10">
            ...
            <Link className={` ${path === "/Search" ? "bg-orange-700/20" : "text-white/40 hover:text-white hover:bg-slate-100/10"}   transition-colors  p-10 text-lg w-full items-center justify-center flex`} href={'/Search'}><FaSearch /></Link>
