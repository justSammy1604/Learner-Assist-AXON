...
export default function Page() {
    ...
    const checkQuestion = () => {
        ...
        if (selectedOption === mcq.questions[currentQuestion].correct) {
            setCurrentResult(1)
    ...
    const goNext = () => {
        currentQuestion < (mcq.questions.length - 1) ? setCurrentQuestion(currentQuestion + 1) : setCompleted(true)
        setGoNext(false)
        setCurrentResult(null)
    }
    if(playerLives===0){
